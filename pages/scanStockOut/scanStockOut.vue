<template>
	<view class="scan-stock-page">
		...
		<view class="form-container">
			...
			<view class="form-item">
				<text>入库时间:</text>
				<uni-datetime-picker v-model="stockInTime" type="datetime" @change="handleTimeChange"></uni-datetime-picker>
			</view>
...
export default {
	...
	methods: {
		...
		saveRecord() {
			if (!this.boxCode || !this.serialNumber || !this.productName || !this.declarationNumber || !this.stockInTime || !this.supplierId) {
				uni.showToast({
					title: '请填写完整信息',
					icon: 'none'
				});
